...
public class task1 {
    public static void main(String[] args) {
        ...
        phonBook.put("Ivan", List.of("8 906 555 33 44", "8 906 777 22 99"));
        phonBook.put("Olesya", List.of("8 906 555 33 55", "8 906 777 22 00"));
        phonBook.put("Igor", List.of("8 906 555 33 66", "8 906 777 22 44"));
        phonBook.put("Tima", List.of("8 906 555 33 77", "8 906 777 22 11"));
        phonBook.put("Vova", List.of("8 906 555 33 88", "8 906 777 22 22"));
